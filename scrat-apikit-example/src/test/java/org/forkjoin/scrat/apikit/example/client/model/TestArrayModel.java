...
public class TestArrayModel {
	...
	public TestArrayModel() {
	}

	public TestArrayModel(java.util.ArrayList<Boolean> booleanValueArray, List<Boolean> booleanValues,
	...
	public String toString() {
		return "TestArrayModel [booleanValueArray=size:" + (booleanValueArray == null ? -1 : booleanValueArray.size())
