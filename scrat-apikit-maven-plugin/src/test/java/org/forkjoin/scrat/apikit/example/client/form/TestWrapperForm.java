...
public class TestWrapperForm {
	...
	public TestWrapperForm() {
	}

	public TestWrapperForm(boolean booleanValue, byte byteValue, String charValue, double doubleValue, float floatValue,
	...
	public String toString() {
		return "TestWrapperForm [booleanValue=" + booleanValue + ",byteValue=" + byteValue + ",charValue=" + charValue
